...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2024 a las 05:05:50
...
INSERT INTO `vehiculo` (`id_vehiculo`, `marca_vehiculo`, `modelo_vehiculo`, `placa_vehiculo`, `id_propietario`) VALUES
...
--
ALTER TABLE `mecanico`
  MODIFY `id_mecanico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
